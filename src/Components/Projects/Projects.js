                        ...
                        <Col md={4} sm={6} xm={1} key={pro.id} className="p-0 mt-4">
                            <div className="card">
                                ...
                                <div className="card-footer">
                                    <a href="https://key-motors.web.app/">View</a>
                                    <button onClick={() => handleViewDetails(pro)} className="project-btn">Details</button>
                                </div>
                            </div>
                        </Col>)
                }
                    ...
                    <Row className="h-100">
                        <Col className="h-100" xm={12} md={8}>
                            <Carousel fade className="h-100">
                                {
                                    details?.img && Object.keys(img).map(image => <Carousel.Item className="h-100">
                                        <img
                                            className="d-block w-100"
                                            src={img[image]}
                                            alt={image}
